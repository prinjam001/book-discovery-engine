...
A machine learning based **book-discovery-engine** built using Python and Streamlit. The application recommends books based on the user's selected book using a **content-based recommendation approach**.
